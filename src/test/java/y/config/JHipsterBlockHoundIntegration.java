...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("y.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("y.security.DomainUserDetailsService", "createSpringSecurityUser");
